...
export default function EditProfileForm(props) {
    let  { userName, dateOfBirth, gender, city, state, mobile, cardNumber, cardHolder } = props.user;

    let date = dateOfBirth ? dateOfBirth.toString("yyyy/mm/dd") : new Date().toString("yyyy/mm/dd")
    ...
    return (
        <div className="container">
            <form onSubmit={(e)=>props.onSubmit(e)}>             
                    ...
                    <div className="form-group ">
                        <label htmlFor="cardNumber" className="col-3 col-form-label">Card Number :</label>
                            <div className="col-9">
                                <input type="number" className="form-control" id="cardNumber" name="cardNumber" value={cardNumber} onChange={(e)=>props.onChange(e)}  />
                            </div>       
                    </div>
                    <div className="form-group ">
                        <label htmlFor="cardHolder" className="col-3 col-form-label">Card Holder :</label>
                            <div className="col-9">
                                <input type="text" className="form-control" id="cardHolder" name="cardHolder" value={cardHolder} onChange={(e)=>props.onChange(e)}  />
                            </div>       
                    </div>
                    <div className="form-group ">
