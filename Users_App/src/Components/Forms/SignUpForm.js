    ...
    return (
        <form className="form" onSubmit={(e)=>props.OnSubmit(e)}>
            ...
            <div className="form-group">
                ...
                <input type = "password" className="form-control" name = "Password" minLength={6} id = "exampleInputPassword1" placeholder = "Password" onChange={(e)=>props.onChange(e)}  required/>
                <small  className = "form-text text-muted">
                            <i id = "password">
                               *Required
                            </i>
            ...
            <div className="form-group">
                ...
                <input type = "password" className="form-control" name = "ConfirmPassword" minLength={6} id = "exampleInputPassword2" placeholder = "Confirm-Password" onChange={(e)=>props.onChange(e)}  required/>
                <small  className = "form-text text-muted">
            ...
            <div className="form-group">
                ...
                <small id = "cardnumber" className = "form-text text-muted">
                            <i>
                               *Required
                            </i>
                </small>
            ...
            <div className="form-group">
                ...
                <small id = "carholder" className = "form-text text-muted">
                            <i>
                               *Required
                            </i>
                </small>
